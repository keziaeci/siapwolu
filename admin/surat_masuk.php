          ...
          <div class="col mt-4">
            ...
            <div class="card shadow-2">
              <div class="card-header">
                <div class="row">
                  <a  class="col-sm-2 btn text-light bg-primary" href="tambah.php"><b>+</b>   Tambah Surat</a>
                  ...
                  <div class="card-body p-1 m-0 table table-responsive">
                    ...
                    <?php foreach($surat as $row) : ?>
                        <tr>
                            ...
                            <td>
                                <a class="btn btn-danger" href="../page/hapus.php?id=<?= $row["id"]; ?>" onclick  ="return confirm('Apakah anda yakin?');">Hapus</a>
                            </td>
                            <?php if($row["file_disposisi"] === "Tidak ada") : ?>
                              ...
                              <?php else: ?>
                              <td>
                                <a class="btn btn-success" target="_blank" href="../page/prev_dispo.php?id=<?= $row['id']; ?>">Preview</a>
                              </td>
                            <?php endif; ?>
                        </tr>
                        <?php $i++; ?>
